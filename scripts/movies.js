...
function alterarLinkFilme2() {
  iframeFilme.setAttribute("src", "https://embed.warezcdn.net/filme/tt1630029");
}
function alterarLinkFilme3() {
  iframeFilme.setAttribute("src", "https://embed.warezcdn.net/filme/tt2911666");
}
function alterarLinkFilme4() {
  iframeFilme.setAttribute("src", "https://embed.warezcdn.net/filme/tt4425200");
}
function alterarLinkFilme5() {
  iframeFilme.setAttribute("src", "https://embed.warezcdn.net/filme/tt6146586");
}
function alterarLinkFilme6() {
  iframeFilme.setAttribute(
    "src",
    "https://embed.warezcdn.net/filme/tt10366206"
  );
}
function alterarLinkFilme7() {
  iframeFilme.setAttribute("src", "https://embed.warezcdn.net/filme/tt2906216");
}

function alterarLinkFilme8() {
  iframeFilme.setAttribute(
    "src",
    "https://embed.warezcdn.net/filme/tt11145118"
  );
}
...
function alterarLinkFilme9() {
  iframeFilme.setAttribute(
    "src",
    "https://embed.warezcdn.net/filme/tt10151854"
  );
}
